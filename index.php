    ...
    <body>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="box">
                    ...
                    ?>
                            <a href="produk.php?kat=<?php echo $k['cid'] ?>" >
                            <div class="col-5">
                                <img src="img/iconcategory.png" width="50px" style="margin-bottom: 5px;">
                                <p><?php echo $k['cname'] ?></p>
                            </div>
                        </a>
                    <?php }}else { ?>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="box">
                    <?php
                        $produk = mysqli_query($conn, "SELECT * FROM product WHERE pstatus = 1 ORDER BY pid  DESC LIMIT 8");
