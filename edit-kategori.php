<?php
    ...
    $kategori = mysqli_query($conn, "SELECT * FROM category WHERE cid = '".$_GET['id']."' ");
            ...
            <div class="container">
                ...
                <div class="box">
                    <form action="" method="POST">
                        <input type="text" name="nama" placeholder="Nama Kategori" class="input-control" value="<?php
                        echo $k->cname ?>" required>
